...
class RateLimiter {
  ...
  async recordFailedAttempt(identifier, ip, userAgent, userId = null, failureReason = null) {
    ...
    try {
      ...
      logger.error('Error logging failed attempt', { error: error?.message, stack: error?.stack });
    }
  }
  ...
  async recordSuccessfulAttempt(identifier, ip, userAgent, userId = null) {
    ...
    try {
      ...
      logger.error('Error logging successful attempt', { error: error?.message, stack: error?.stack });
    }
  }

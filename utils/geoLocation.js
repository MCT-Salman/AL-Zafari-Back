...
export const getLocationFromIP = async (ip) => {
  try {
    ...
    logger.error('Error getting location from IP', { message: error?.message, stack: error?.stack, ip });
    return {
      success: false,
...
export const getISPFromIP = async (ip) => {
  try {
    ...
    logger.error('Error getting ISP from IP', { message: error?.message, stack: error?.stack, ip });
    return {
      success: false,
...
export const updateSessionWithIPInfo = async (sessionId, ip, userAgent = null) => {
  try {
    ...
    logger.error('Error updating session with IP info', { message: error?.message, stack: error?.stack, sessionId, ip });
